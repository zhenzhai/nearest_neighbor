...
if __name__ == "__main__"
    ...
    np.savetxt('convert_data/train_vectors', im, delimiter=',', fmt='%d')
    np.savetxt('convert_data/train_labels', la, fmt='%d')
    ...
    np.savetxt('convert_data/test_vectors', im2, delimiter=',', fmt='%d')
    np.savetxt('convert_data/test_labels', la2, fmt='%d')
