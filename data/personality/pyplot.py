...
def spill_vspill():
	...
	spill_x, spill_y, spill_label = read_partial_file_w_label(4,3,5,4,20,2,'kd_spill_tree.dat')
	vspill_x, vspill_y, vspill_label = read_partial_file_w_label(4,3,5,0,10,2,'kd_v_spill_tree.dat')
...
def ran_spill_vspill():
	...
	vspill_x, vspill_y, vspill_label = read_partial_file_w_label(4,3,5,1,10,2,'kd_v_spill_tree.dat')
...
def ran2_kd():
	...
	figure = plt.gcf()
	figure.set_size_inches(13, 10)
	plt.savefig("person_ran2_kd.png")
...
def ran8_kd():
	...
	figure = plt.gcf()
	figure.set_size_inches(13, 10)
	plt.savefig("person_ran8_kd.png")
...
def kd_pca_ran():
	...
	figure = plt.gcf()
	figure.set_size_inches(13, 10)
	plt.savefig("person_kd_pca_ran8.png")
...
def main():
	font = {'size' : 25}
	plt.rc('font', **font)
	plt.title('Personality True NN Percentage', y=1.02)
